...
export const aboutData: AboutData = {
  ...
  closing:
    'This site, like most of what I build these days, is put together in collaboration with AI coding agents: I set direction and review, they write the code. It felt right to say that plainly here rather than pretend otherwise.',
};
